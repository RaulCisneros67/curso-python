...
print(f'-{diferencia_con_max}% menos que el mas rapido')
print(f'-{diferencia_con_promedio}% menos que el mas rapido')
print("------------------------------------------------------------------------------")
...
#Mosttrando diferencias si los cursos duran 10 horas 
